<form action="{{ url('/jenisPengguna/ajax') }}" method="POST" id="form-tambah">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="kode_jenis_pengguna" id="kode_jenis_pengguna" class="form-control" required>
